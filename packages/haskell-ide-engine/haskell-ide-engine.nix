...
, data-default, Diff, directory, either, fetchgit, filepath, ghc
, ghc-mod-core, gitrev, haskell-lsp, hie-apply-refact, hie-base
, hie-brittany, hie-build-plugin
, hie-example-plugin2, hie-ghc-mod, hie-haddock
...
, unordered-containers, vector, vinyl, yi-rope, ekg
}:
mkDerivation {
  ...
  executableHaskellDepends = [
    ...
    hie-apply-refact hie-build-plugin
    hie-example-plugin2 hie-ghc-mod hie-hare hie-hoogle
  ...
  testHaskellDepends = [
    ...
    haskell-lsp hie-apply-refact hie-base
    hie-example-plugin2 hie-ghc-mod hie-hare hie-hoogle
